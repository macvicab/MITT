function [Data,Config] = OrganizeIQData(GUIControl,CSVControl)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Config = CalcConfigIQ(CSVControl,inname)

System_Id = load(inname,'System_Id');
fieldmem = fieldnames(System_Id);
nftot = length(fieldmem);
for nf = 1:nftot
    eval(['Config.',fieldmem{nf},' = System_Id.',fieldmem{nf},';']);
end
